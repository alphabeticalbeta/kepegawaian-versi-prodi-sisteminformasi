    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">
                Kelola dan pantau usulan jabatan dari fakultas {{ $unitKerja->nama ?? 'Anda' }}.
            </p>
        </div>
                            ...
                            <tr class="bg-white border-b">
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 mb-4">Belum ada periode usulan jabatan yang tersedia untuk fakultas Anda.</p>
                                        <p class="text-xs text-gray-400">Hubungi Admin Universitas untuk membuka periode usulan baru.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
